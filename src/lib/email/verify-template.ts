// src/lib/email/verify-template.ts
...
export function getVerificationEmailHtml({
  ...
  return `
    ...
    <head>
      ...
      <title>Authenticate Identity Node | NEXUS</title>
    </head>
              ...
              <tr>
                <td style="padding: 32px;">
                  ...
                  <p style="font-size: 13px; color: #a1a1aa; line-height: 1.6; margin: 0 0 24px 0;">
                    ...
                    A new cryptographic identity cluster instantiation request has been dispatched to your address. Click below to verify your node signature.
                  </p>

                  <!-- CTA Button -->
                  <div style="text-align: center; margin: 32px 0;">
                    <a href="${verificationUrl}" target="_blank" style="display: inline-block; background-color: #84cc16; color: #09090b; font-weight: 800; font-size: 13px; text-decoration: none; padding: 14px 28px; border-radius: 12px; text-transform: uppercase; letter-spacing: 1px; box-shadow: 0 0 20px rgba(132,204,34,0.3);">
                      Authorize Identity Node &rarr;
                    </a>
                  </div>

                  <p style="font-size: 11px; color: #71717a; line-height: 1.5; margin: 24px 0 0 0; border-t: 1px solid #18181b; padding-top: 16px;">
                    If you did not initiate this terminal handshake, ignore this transmission. This key link will expire shortly.
                  </p>
                </td>
              </tr>
