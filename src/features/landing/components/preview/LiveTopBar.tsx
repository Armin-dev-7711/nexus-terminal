...
export function LiveTopBar() {
  return (
    // 🚀 فیکس شد: bg-zinc-950 و backdrop-blur-none در موبایل
    <div className='w-full h-16 shrink-0 flex items-center justify-between px-4 md:px-6 border-b border-border/40 bg-zinc-950 md:bg-background/80 backdrop-blur-none md:backdrop-blur-md relative z-50'>
      {/* بقیه کدها کاملاً یکسان... */}
